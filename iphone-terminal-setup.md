...
> **Примечание:** Эта инструкция — для ручной установки на удалённом сервере. Для автоматической установки (включая macOS) используй `bash setup.sh` — он сам определит тип машины.
